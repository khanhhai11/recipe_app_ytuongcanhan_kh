...
import 'package:recipe_app/recipe_extractor/scarpers.dart';
import 'package:recipe_app/recipe_extractor/recipe_extractor_models/recipe_data.dart';
  ...
  for (var scarper in scarpers) {
    if (scarper.host == domain) {
      ...
      return RecipeData(
          ...
          source: address,
          prepTime: scarper.prepTime(),
          cookTime: scarper.cookTime(),
          calories: scarper.calories(),
          fat: scarper.fat(),
          carbs: scarper.carbs(),
          protein: scarper.protein(),
      );
    }
  }
  return RecipeData();
